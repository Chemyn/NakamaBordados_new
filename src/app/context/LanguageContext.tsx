...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'checkout.coupon.abandoned_help': 'Usa aquí el código que recibiste para recuperar tu carrito abandonado.',
    'checkout.coupon.label': 'Código de carrito abandonado',
    'checkout.coupon.empty': 'Escribe el código que recibiste.',
    'checkout.coupon.invalid': 'El código no es válido.',
    'checkout.coupon.validating': 'Validando…',
    'checkout.coupon.remove': 'Quitar cupón de carrito abandonado',
  ...
  en: {
    ...
    'checkout.coupon.abandoned_help': 'Use the code you received to recover your abandoned cart.',
    'checkout.coupon.label': 'Abandoned-cart code',
    'checkout.coupon.empty': 'Enter the code you received.',
    'checkout.coupon.invalid': 'The code is not valid.',
    'checkout.coupon.validating': 'Validating…',
    'checkout.coupon.remove': 'Remove abandoned-cart coupon',
