...
### Community 1 - "nakama_wh_rest_manual_product_save"
Cohesion: 0.25
Nodes (23): nakama_products_bump_cache(), nakama_wh_apply_delta(), nakama_wh_get_row(), nakama_wh_install_schema(), nakama_wh_label(), nakama_wh_log_move(), nakama_wh_merge_duplicates(), nakama_wh_moves_table() (+15 more)
...
### Community 4 - "App.tsx"
Cohesion: 0.08
Nodes (41): jspdf, jszip, useAuth(), App(), availableGarmentPositions, getPositionSizeError(), AuthGateModal(), AuthGateModalProps (+33 more)
...
### Community 7 - "[id].tsx"
Cohesion: 0.11
Nodes (38): Busy, styles, styles, styles, AppButton(), AppButtonProps, PALETTE, styles (+30 more)
...
Cohesion: 0.08
Nodes (36): Edits, styles, Tab, TABS, WarehouseScreen(), ProductRowComponent(), SegmentedTabs(), SegmentOption (+28 more)
...
Cohesion: 0.10
Nodes (34): nakama_add_quote_batch_to_wc_cart(), nakama_add_quote_to_wc_cart(), nakama_cart_bridge_handler(), nakama_check_coupon_logic(), nakama_checkout_bridge_apply_promotion(), nakama_checkout_return_url(), nakama_finalize_quote_sources(), nakama_graphql_order_quote_payment_eligible() (+26 more)
...
### Community 23 - "vitest"
Cohesion: 0.07
Nodes (23): @testing-library/react, vitest, AffiliateProductRequest(), address, products, AffiliateProgress(), fill(), mxn (+15 more)
...
Cohesion: 0.22
Nodes (13): CartPage(), CheckoutPage(), AbandonedCartCoupon(), mocks, AffiliateCodeField(), getVariationAttr(), useCart(), buildCheckoutBridgeUrl() (+5 more)
...
Cohesion: 0.08
Nodes (8): nakama_hero_handle_save(), add_settings_error(), Nakama_Campaigns, Nakama_Context, Nakama_Customer_History, Nakama_Settings, WC_Coupon, wp_generate_uuid4()
...
Cohesion: 0.13
Nodes (29): nakama_prod_card(), nakama_prod_color_es(), nakama_prod_item_attributes(), nakama_prod_item_images(), nakama_prod_latest_rework(), nakama_prod_normalize(), nakama_prod_normalize_sku(), nakama_prod_order_cycles() (+21 more)
...
Cohesion: 0.10
Nodes (40): AffiliateDashboard(), mxn, mocks, Props, Selection, metadata, AffiliateAccess, AffiliateBenefit (+32 more)
...
### Community 62 - "products.ts"
Cohesion: 0.11
Nodes (24): CATEGORIES, fetchProductsByCategory(), getProductsByCategory(), PRODUCTS, ProductsSearchResult, ProductLoader(), dynamic, sitemap() (+16 more)
...
Cohesion: 0.23
Nodes (12): nakama_create_quote_order(), nakama_get_order_confirmation(), nakama_quote_pdf_upload(), nakama_register_customer(), nakama_social_new_user_role(), WP_REST_Request, nakama_prod_rest_orders(), nakama_products_submit_review() (+4 more)
...
Cohesion: 0.16
Nodes (20): ApplyCouponResult, CartContext, CartContextType, CartItem, CartProvider(), QuoteCartItem, ValidatedPromotionCode, validatePromotionCode() (+12 more)
...
Cohesion: 0.14
Nodes (16): AffiliateReferralCapture(), mocks, Navbar(), SearchBar(), CurrencyContext, CurrencyContextProps, CurrencyData, CurrencyProvider() (+8 more)

### Community 119 - "apiOrigin"
Cohesion: 0.20
Nodes (11): MAINTENANCE_ENDPOINT(), MaintenanceToggle(), MaintenanceData, MaintenanceWrapper(), SocialLinks, SOCIALS, ProductClient(), ProductClientProps (+3 more)
...
Cohesion: 0.08
Nodes (43): fetchProductById(), fetchProducts(), addToCart(), checkout(), emptyCart(), fetchCart(), fetchCheckoutData(), getAuthHeaders() (+35 more)
...
Cohesion: 0.11
Nodes (25): Footer(), FreeShippingBadge(), CategoriesExplore(), LazyCategorySection(), ScrollContainer(), useDraggableScroll(), HeroSources, ScrollytellingHero() (+17 more)
...
Cohesion: 0.24
Nodes (10): nakama_hero_default_config(), nakama_hero_get_config(), nakama_hero_media_field(), nakama_hero_merge_config(), nakama_hero_render_admin_page(), nakama_hero_rest_get(), nakama_prod_render_user_field(), nakama_wh_render_user_field() (+2 more)
...
### Community 163 - "nakama-warehouse.php"
Cohesion: 0.18
Nodes (18): nakama_wh_color_canonical(), nakama_wh_compare_items(), nakama_wh_group_priority(), nakama_wh_item_attributes(), nakama_wh_key(), nakama_wh_match_norm(), nakama_wh_norm_part(), nakama_wh_parent_estilo() (+10 more)

### Community 164 - "wc_get_product"
Cohesion: 0.20
Nodes (15): nakama_wh_apply_variation_status(), nakama_wh_catalog_maps_table(), nakama_wh_catalog_product_out(), nakama_wh_manual_product_out(), nakama_wh_manual_variation_parts(), nakama_wh_resolve_for_variation(), nakama_wh_rest_catalog_product_variations(), nakama_wh_rest_catalog_products() (+7 more)

### Community 167 - "AccountSectionNav.tsx"
Cohesion: 0.32
Nodes (5): AccountSection, AccountSectionId, AccountSectionNav(), AccountSectionNavProps, CUSTOMER_SECTIONS

### Community 168 - "WP_Error"
Cohesion: 0.29
Nodes (14): nakama_update_account_profile(), nakama_prod_cycle_owner(), nakama_prod_human_duration(), nakama_prod_order_progress(), nakama_prod_rest_finish(), nakama_prod_rest_finish_v2(), nakama_prod_rest_pdf_delete(), nakama_prod_rest_reports() (+6 more)

### Community 169 - "nakama_prod_rest_review"
Cohesion: 0.31
Nodes (14): nakama_prod_active_cycle(), nakama_prod_create_cycle(), nakama_prod_cycle_review(), nakama_prod_cycles_table(), nakama_prod_ensure_finished_cycle(), nakama_prod_install_schema(), nakama_prod_latest_cycle(), nakama_prod_order_units() (+6 more)

### Community 171 - "AuthModeTabs.test.tsx"
Cohesion: 0.18
Nodes (8): @testing-library/user-event, mocks, AUTH_MODES, AuthMode, AuthModeTabs(), AuthModeTabsProps, TrackingFeedback(), TrackingFeedbackProps
...
### Community 178 - "AffiliateEvidence.tsx"
Cohesion: 0.36
...
- **Why does `vitest` connect `vitest` to `Product`, `production-api.ts`, `App.tsx`, `src/lib/warehouse-api.ts`, `AuthContext.tsx`, `fetchGraphQL`, `mi-cuenta/page.tsx`, `analytics.ts`, `OrderDetailScreen`, `SocialLoginButtons.tsx`, `package.json`, `cart/page.tsx`, `AccountSectionNav.tsx`, `AuthModeTabs.test.tsx`, `AffiliateEvidence.tsx`, `currency-rate.ts`, `LuffyCharacter.tsx`, `affiliates-api.ts`, `AccountColors.test.ts`, `CartContext.tsx`, `app/layout.tsx`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `Nakama_Affiliates_Repository` connect `Nakama_Affiliates_Repository` to `nakama-hero-manager.php`, `Nakama_Affiliates_Private_Files`, `Nakama_Affiliates_Permissions`, `Nakama_Affiliates_Codes`, `Nakama_Affiliates_Requests`, `Nakama_Affiliates_REST`, `Nakama_Affiliates_Domain`, `absint`, `Nakama_Affiliates_Products`, `Nakama_Affiliates_Benefits`, `.process_action`, `Nakama_Affiliates_Admin`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `absint()` connect `absint` to `nakama-discounts-admin-ui-test.php`, `nakama-products-api.php`, `nakama-checkout-tools-test.php`, `nakama-checkout-tools.php`, `DateTimeImmutable`, `.process_action`, `Nakama_Affiliates_Admin`?**
