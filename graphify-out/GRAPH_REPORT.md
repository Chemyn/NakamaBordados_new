...
## Corpus Check
- 315 files · ~4,257,253 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2745 nodes · 4853 edges · 169 communities (113 shown, 43 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 522 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `695d9d55`
...
## Communities (169 total, 43 thin omitted)
...
Cohesion: 0.14
Nodes (47): nakama_products_bump_cache(), nakama_wh_apply_delta(), nakama_wh_apply_variation_status(), nakama_wh_catalog_maps_table(), nakama_wh_catalog_product_out(), nakama_wh_color_canonical(), nakama_wh_effective_stock(), nakama_wh_get_row() (+39 more)
...
Cohesion: 0.11
Nodes (53): nakama_prod_active_cycle(), nakama_prod_card(), nakama_prod_create_cycle(), nakama_prod_cycle_owner(), nakama_prod_cycle_review(), nakama_prod_cycles_table(), nakama_prod_ensure_finished_cycle(), nakama_prod_human_duration() (+45 more)
...
Cohesion: 0.13
Nodes (25): CartPage(), CheckoutPage(), AbandonedCartCoupon(), AffiliateCodeField(), Navbar(), SearchBar(), useAuth(), useCart() (+17 more)
...
Cohesion: 0.10
Nodes (21): AffiliateReferralCapture(), mocks, Analytics(), BuildUpdateNotice(), BuildUpdateNoticeProps, CookieBanner(), Footer(), Message (+13 more)
...
Cohesion: 0.05
Nodes (45): h2Style, leadStyle, liStyle, markerStyle, PrivacyPage(), pStyle, secStyle, ulStyle (+37 more)
...
Cohesion: 0.07
Nodes (8): Nakama_Discount_Codes, current_datetime(), Nakama_Campaigns, Nakama_Context, Nakama_Customer_History, Nakama_Settings, sanitize_key(), wp_generate_uuid4()
...
Cohesion: 0.08
Nodes (31): PersonalDetailsEditor(), PersonalDetailsProps, SaveProfile, SaveResult, ShippingAddressEditor(), ShippingAddressProps, AccountSection, AccountSectionId (+23 more)
...
### Community 99 - "WP_Error"
Cohesion: 0.26
Nodes (14): nakama_check_coupon_logic(), nakama_create_quote_order(), nakama_get_order_confirmation(), nakama_quote_pdf_upload(), nakama_register_customer(), nakama_update_account_profile(), WP_REST_Request, nakama_products_submit_review() (+6 more)
...
Cohesion: 0.12
Nodes (27): isomorphic-dompurify, DropCard(), DropCardProps, DropCountdown(), DropCountdownProps, twoDigits(), getPricing(), ProductPrice() (+19 more)
...
Cohesion: 0.22
Nodes (15): nakama_changelog_commit_items(), nakama_changelog_commit_release_id(), nakama_changelog_date_display(), nakama_changelog_entries(), nakama_changelog_git_commits(), nakama_changelog_git_entry(), nakama_changelog_git_snapshot(), nakama_changelog_handle_manual_refresh() (+7 more)
...
Cohesion: 0.08
Nodes (29): MAINTENANCE_ENDPOINT(), MaintenanceToggle(), MaintenanceData, MaintenanceWrapper(), SocialLinks, SOCIALS, buttonStyle, dividerStyle (+21 more)
...
Cohesion: 0.07
Nodes (4): Nakama_Affiliates_Documents, Nakama_Affiliates_Permissions, Nakama_Affiliates_REST, WP_REST_Request

### Community 145 - "OrderDetailScreen"
Cohesion: 0.40
Nodes (4): formatDuration(), OrderDetailScreen(), ANDROID_SYSTEM_NAV_CLEARANCE, bottomActionPadding()

### Community 146 - ".render"
Cohesion: 0.22
...
### Community 153 - "remove_accents"
Cohesion: 0.20
Nodes (11): nakama_prod_color_es(), nakama_prod_item_attributes(), nakama_wh_compare_items(), nakama_wh_group_priority(), nakama_wh_item_attributes(), nakama_wh_match_norm(), nakama_wh_norm_part(), nakama_wh_resolve_for_item() (+3 more)

### Community 154 - "wp_strip_all_tags"
Cohesion: 0.47
...
### Community 169 - "nakama_logout_session"
Cohesion: 0.50
...
- **718 isolated node(s):** `net`, `client`, `eslintConfig`, `{ existsSync }`, `{ join }` (+713 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 1394 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **43 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `vitest` connect `vitest` to `ProductClient.tsx`, `production-api.ts`, `CartContext.tsx`, `App.tsx`, `src/lib/warehouse-api.ts`, `apiOrigin`, `cart/page.tsx`, `app/layout.tsx`, `OrderDetailScreen`, `currency-rate.ts`, `affiliates-api.ts`, `pedido-confirmado/page.tsx`, `package.json`, `graphql-client.ts`, `mi-cuenta/page.tsx`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `Nakama_Affiliates_Repository` connect `Nakama_Affiliates_Repository` to `Nakama_Affiliates_Private_Files`, `Nakama_Affiliates_Codes`, `nakama-discounts-test.php`, `Nakama_Affiliates_REST`, `Nakama_Affiliates_Domain`, `Nakama_Drops_Admin`, `.render`, `Nakama_Affiliates_Products`, `Nakama_Affiliates_Closures`, `Nakama_Affiliates_Benefits`, `Nakama_Affiliates_Admin`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `absint()` connect `Nakama_Drops_Admin` to `nakama-discounts-admin-ui-test.php`, `nakama-discounts-test.php`, `nakama-products-api.php`, `nakama-checkout-tools-test.php`, `nakama-checkout-tools.php`, `DateTimeImmutable`, `.render`?**
