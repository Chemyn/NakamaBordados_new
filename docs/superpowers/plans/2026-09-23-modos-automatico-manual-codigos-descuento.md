...
- [ ] **Step 3: Implement schema v2 and mode validation**
...
- [ ] **Step 4: Add failing administrative UI assertions**
...
- [ ] **Step 5: Implement the administrative radio groups and inline validation**
...
- [ ] **Step 6: Run the focused server and UI suites**
...
- [ ] **Step 1: Write failing engine tests for hidden, compatible and exclusive manual codes**
...
- [ ] **Step 3: Implement context and candidate visibility**
...
- [ ] **Step 4: Write failing session and order snapshot tests**
...
- [ ] **Step 5: Implement discount-code filter hooks and session cleanup**
...
- [ ] **Step 6: Persist the mode and clear stale unlocks**
...
- [ ] **Step 7: Run the discounts and cart suites**
...
- [ ] **Step 1: Write failing typed resolver tests**
...
- [ ] **Step 2: Run the checkout-tools suite and verify it fails**

Expected: FAIL because the endpoint currently returns only native coupon fields.

- [ ] **Step 3: Implement typed resolution without browser authority**
...
- [ ] **Step 4: Write failing bridge precedence and cleanup tests**
...
- [ ] **Step 5: Implement bridge handling**
...
- [ ] **Step 6: Run the checkout-tools suite**
...
- [ ] **Step 1: Write failing context tests for manual recognition**
...
- [ ] **Step 2: Run `CartContext.test.tsx` and verify it fails**

Expected: FAIL because `couponKind` and `nakama_manual` do not exist.

- [ ] **Step 3: Implement the typed promotional state**
...
- [ ] **Step 4: Write failing bridge URL tests**
...
- [ ] **Step 5: Implement exclusive URL serialization and pass the kind from both pages**
...
- [ ] **Step 6: Run the four focused web suites**
...
- [ ] **Step 3: Implement the unified copy and feedback**
...
- [ ] **Step 4: Update page test dictionaries and assertions**
...
- [ ] **Step 5: Run component, context, cart and checkout tests**
...
- [ ] **Step 3: Run all focused PHP tests**
...
- [ ] **Step 4: Run focused frontend tests, lint and production build**
...
- [ ] **Step 5: Rebuild ZIP artifacts reproducibly**
...
- [ ] **Step 7: Review the final diff and rerun `git diff --check`**
