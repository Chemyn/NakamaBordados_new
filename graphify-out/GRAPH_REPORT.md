...
## Corpus Check
- 313 files · ~4,254,421 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2717 nodes · 4816 edges · 164 communities (112 shown, 39 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 512 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5929f705`
...
Cohesion: 0.05
Nodes (118): nakama_prod_active_cycle(), nakama_prod_card(), nakama_prod_color_es(), nakama_prod_create_cycle(), nakama_prod_cycle_owner(), nakama_prod_cycle_review(), nakama_prod_cycles_table(), nakama_prod_ensure_finished_cycle() (+110 more)
...
Cohesion: 0.16
Nodes (22): nakama_get_maintenance_status(), nakama_products_add_cors(), nakama_products_attribute_key_map(), nakama_products_cache_key(), nakama_products_cache_version(), nakama_products_catalog_clean_text(), nakama_products_catalog_image(), nakama_products_catalog_price() (+14 more)
...
### Community 13 - "ProductClient.tsx"
Cohesion: 0.11
Nodes (27): isomorphic-dompurify, DropCardProps, Navbar(), getPricing(), ProductPrice(), SearchBar(), CartContextType, CartItem (+19 more)
...
Cohesion: 0.11
Nodes (20): AffiliateReferralCapture(), mocks, Analytics(), BuildUpdateNotice(), BuildUpdateNoticeProps, CookieBanner(), Message, WhatsAppButton() (+12 more)
...
Cohesion: 0.05
Nodes (42): @testing-library/react, @testing-library/user-event, AccountProgress(), AccountProgressProps, AccountProgressStep, steps, AccountSection, AccountSectionId (+34 more)
...
Cohesion: 0.09
Nodes (33): CartPage(), cartContext, router, CheckoutPage(), cartContext, checkoutMocks, router, AbandonedCartCoupon() (+25 more)
...
Cohesion: 0.06
Nodes (9): Nakama_Discount_Codes, add_settings_error(), current_datetime(), Nakama_Campaigns, Nakama_Context, Nakama_Customer_History, Nakama_Settings, sanitize_key() (+1 more)
...
Cohesion: 0.06
Nodes (8): FakeCheckoutOrder, FakeErrors, FakeFee, FakeLineItem, FakeResponse, get_post_status(), rest_ensure_response(), WP_User
...
Cohesion: 0.10
Nodes (27): nextConfig, next, AffiliateDashboard(), mxn, mocks, metadata, metadata, dynamic (+19 more)
...
### Community 75 - "is_wp_error"
Cohesion: 0.23
Nodes (13): nakama_currency_info(), nakama_get_usd_rate(), nakama_get_usd_rate_details(), nakama_get_track_timeline(), nakama_products_build_product(), nakama_products_build_variation(), nakama_products_list(), nakama_products_search_categories() (+5 more)
...
### Community 99 - "nakama_create_quote_order"
Cohesion: 0.12
...
Cohesion: 0.11
Nodes (19): vitest, DropCard(), DropCountdown(), DropCountdownProps, twoDigits(), copy, DropsClient(), metadata (+11 more)
...
### Community 162 - "Affiliate_Fake_Product"
Cohesion: 0.10
...
- **Why does `vitest` connect `vitest` to `pdfGenerator.ts`, `production-api.ts`, `CartContext.tsx`, `src/lib/warehouse-api.ts`, `apiOrigin`, `ProductClient.tsx`, `app/layout.tsx`, `OrderDetailScreen`, `currency-rate.ts`, `pedido-confirmado/page.tsx`, `affiliates-api.ts`, `mi-cuenta/page.tsx`, `package.json`, `graphql-client.ts`, `AuthContext.tsx`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `Nakama_Affiliates_Repository` connect `Nakama_Affiliates_Repository` to `Nakama_Affiliates_Private_Files`, `Nakama_Affiliates_Codes`, `nakama-discounts-test.php`, `Nakama_Affiliates_REST`, `Nakama_Affiliates_Domain`, `Nakama_Drops_Admin`, `.render`, `Nakama_Affiliates_Products`, `Nakama_Affiliates_Requests`, `Nakama_Affiliates_Permissions`, `Nakama_Affiliates_Benefits`, `Nakama_Affiliates_Admin`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `bottomActionPadding()` connect `OrderDetailScreen` to `[id].tsx`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Are the 46 inferred relationships involving `Nakama_Affiliates_Repository` (e.g. with `.count_rows()` and `.paged_rows()`) actually correct?**
  _`Nakama_Affiliates_Repository` has 46 INFERRED edges - model-reasoned connections that need verification._
