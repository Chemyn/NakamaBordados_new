...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'checkout.coupon.placeholder': 'Ej. NAKAMA30K o NICO',
    'checkout.coupon.apply': 'Aplicar código',
    'checkout.coupon.toggle': '¿Tienes un código?',
    'checkout.coupon.help': 'Escribe una promoción, un cupón de recuperación o un código de afiliado. Lo identificaremos automáticamente.',
    'checkout.coupon.label': 'Código de descuento o afiliado',
    'checkout.coupon.empty': 'Escribe un código de descuento o afiliado.',
    'checkout.coupon.invalid': 'No encontramos una promoción o un afiliado vigente con ese código.',
    ...
    'checkout.promotion_choice.help': 'Solo se aplicará una promoción. Puedes cambiarla antes de ir al checkout.',
    ...
    'checkout.affiliate.help': 'Apoya a tu creador favorito. Si agregas otro código, podrás elegir cuál usar.',
  ...
  en: {
    ...
    'checkout.coupon.placeholder': 'E.g. NAKAMA30K or NICO',
    'checkout.coupon.apply': 'Apply code',
    'checkout.coupon.toggle': 'Do you have a code?',
    'checkout.coupon.help': 'Enter a promotion, recovery coupon, or affiliate code. We will identify it automatically.',
    'checkout.coupon.label': 'Discount or affiliate code',
    'checkout.coupon.empty': 'Enter a discount or affiliate code.',
    'checkout.coupon.invalid': 'We could not find a current promotion or affiliate with that code.',
    ...
    'checkout.coupon.affiliate_success': 'Affiliate code recognized.',
    'checkout.promotion_choice.title': 'Choose which promotion to use',
    'checkout.promotion_choice.help': 'Only one promotion will be applied. You can change it before checkout.',
    'checkout.promotion_choice.affiliate': 'Affiliate code',
    'checkout.promotion_choice.coupon': 'Promotional code',
    'checkout.affiliate.title': 'Affiliate code',
    'checkout.affiliate.help': 'Support your favorite creator. If you add another code, you can choose which one to use.',
